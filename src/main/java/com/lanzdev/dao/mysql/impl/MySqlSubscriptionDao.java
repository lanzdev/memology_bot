...
public class MySqlSubscriptionDao
    ...
    public List<Subscription> getByChat(Long chatId) {
        ...
        try (Connection connection = ConnectionPool.getConnection();
                PreparedStatement stmt = connection.prepareStatement(Query.SELECT_SUBSCRIPTION_BY_CHAT)) {
    ...
    public Subscription getByChatAndWall(Long chatId, String wallDomain) {
        ...
        try (Connection connection = ConnectionPool.getConnection();
                PreparedStatement stmt = connection.prepareStatement(Query.SELECT_SUBSCRIPTION_BY_CHAT_AND_WALL)) {
